...
namespace BalanceGlobal.Service
{
    ...
    public interface IReservoriosService
    {
        ...
        Task DeleteReservorios(int id, string userName);
        Task<ReservoriosModel> ReadReservorios(int id);
    }
    public class ReservoriosService : IReservoriosService
    {
        ...
        public async Task DeleteReservorios(int id, string userName)
        {
            await _repository.RemoveAsync(id, userName);
        }

        public async Task<ReservoriosModel> ReadReservorios(int id)
        {
